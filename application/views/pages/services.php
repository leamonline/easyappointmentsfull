...
<div class="container-fluid backend-page" id="services-page">
    <div class="row" id="services">
        ...
        <div class="record-details column col-12 col-md-5">
            ...
            <div class="border rounded mb-3 p-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is-walkin">

                    <label class="form-check-label" for="is-walkin">
                        Walk-in Service
                    </label>
                </div>
                ...
                <div class="form-text text-muted">
                    <small>
                        Walk-in services (e.g. nail trim, ear clean) don't require booking and don't affect slot capacity.
                    </small>
                </div>
            </div>
