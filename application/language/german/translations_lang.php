...
$lang['about_app'] = 'Über Smarter Dog';
...
$lang['about_app_info'] = 'Smarter Dog ist eine extrem anpassungsfähige Internet-Applikation, die es Ihren Kunden ermöglicht, einen Termin mit Ihnen über das Internet zu vereinbaren. Darüberhinaus gibt es Ihnen die Möglichkeit, Ihre Daten mit dem CalDAV/Google-Kalender zu synchronisieren, so dass Sie diese mit anderen Dienstleistungsprogrammen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von Smarter Dog haben sollten, können Sie die offizielle Google-Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie das Finden von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ist unter der GPLv3-Lizenz lizensiert. Bei jeglicher Nutzung des Codes für Smarter Dog stimmen Sie den Nutzungsbedingungen zu wie sie auf folgender Seite aufgeführt sind:';
...
$lang['ea_update_success'] = 'Smarter Dog wurde erfolgreich aktualisiert.';
...
$lang['api_token_hint'] = 'Setze einen geheimen Token um die tokenbasierte Authentifizierung für die Smarter Dog API zu aktivieren.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Mit der API können Sie über das HTTP-Protokoll und die verfügbaren API-Endpunkte mit allen Smarter Dog-Daten interagieren und Ihre eigenen Integrationen erstellen.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Diese Integration ermöglicht es Ihnen, sich mit einem bestehenden LDAP-Server zu verbinden und Benutzer automatisch in Smarter Dog zu importieren und ihnen ein SSO mit ihrem Verzeichnispasswort zu ermöglichen (der Benutzername muss übereinstimmen).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
