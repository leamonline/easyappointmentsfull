...
class Google extends EA_Controller
{
    ...
    /**
     * Complete synchronization of appointments between Google Calendar and Smarter Dog.
     *
        ...
        try {
            ...
            foreach ($local_events as $local_event) {
                ...
                try {
                    ...
                    // If Google Calendar event is different from Smarter Dog appointment then update Smarter Dog record.
                    ...
                    // Appointment not found on Google Calendar, delete from Smarter Dog.
            ...
            // Add Google Calendar events that do not exist in Smarter Dog.
     ...
     * documentation of OAuth), every Smarter Dog installation should use its own calendar api key. So in every
     * api console account, the "http://path-to-Smarter Dog/google/oauth_callback" should be included in an
