...
$lang['about_app_info'] = 'Smarter Dog er et specielfremstillet internet applikation som giver mulighed for kunderne at booke bestillinger med dig via internettet. Endvidere leverandørens evne til at synkronisere dine data med Google kalender, så du kan bruge dem med andre tjenester.';
$lang['current_version'] = 'Nuværende version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Hvis du støder på nogen problemer når du bruger Smarter Dog kan du søge i officiel Google gruppe for svar. Du må også lave en levering i google kode side for at hjælpe opstående proces.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'Smarter Dog er autoriseret til GPLv3 lisens. Ved at bruge koden Smarter Dog i hvert fald, du giver samtykke til periodens beskrivelse i det følgende url.';
...
$lang['ea_update_success'] = 'Smarter Dog er blevet opdateret.';
...
$lang['api_token_hint'] = 'Indstil en hemmelig token for at aktivere tokenbaseret autentificering af Smarter Dog API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API giver dig mulighed for at interagere med alle Smarter Dog-data via HTTP-protokollen og de tilgængelige API-endepunkter og oprette dine egne integrationer.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Denne integration giver dig mulighed for at oprette forbindelse til en eksisterende LDAP-server og automatisk importere brugere til Smarter Dog og lade dem SSO med deres katalogadgangskode (brugernavnet skal matche).';
$lang['host'] = 'Vært';
$lang['port'] = 'Port';
