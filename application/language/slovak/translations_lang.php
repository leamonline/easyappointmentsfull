...
$lang['ea_update_success'] = 'Smarter Dog bolo úspešne aktualizované.';
...
$lang['api_token_hint'] = 'Nastavte tajný token, aby ste povolili autentifikáciu na základe tokenov rozhrania Smarter Dog API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API umožňuje interakciu so všetkými údajmi Smarter Dog cez protokol HTTP a dostupné koncové body API a vytváranie vlastných integrácií.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Táto integrácia vám umožňuje pripojiť sa k existujúcemu LDAP serveru a automaticky importovať používateľov do Smarter Dog a umožniť im SSO s ich adresárskym heslom (užívateľské meno musí súhlasiť).';
$lang['host'] = 'Hostiteľ';
$lang['port'] = 'Port';
