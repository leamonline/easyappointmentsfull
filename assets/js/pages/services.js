...
App.Pages.Services = (function () {
    ...
    function addEventListeners() {
        ...
        $services.on('click', '#save-service', () => {
            const service = {
                ...
                is_walkin: Number($isWalkin.prop('checked')),
    ...
    function resetForm() {
        ...
        $services.find('.record-details #is-walkin').prop('checked', false);
    ...
    function display(service) {
        ...
        $isWalkin.prop('checked', Boolean(service.is_walkin));
