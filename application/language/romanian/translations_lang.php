...
$lang['about_app'] = 'Despre Smarter Dog';
...
$lang['about_app_info'] = 'Smarter Dog este o aplicatie web usor personalizabila care permite clientilor sa programeze întâlniri cu dumneavoastra de pe internet. Mai mult, are abilitatea de a sincroniza datele dumneavoastra cu Calendarul Google pentru a-l putea folosi împreuna cu alte servicii.';
$lang['current_version'] = 'Versiunea Curenta';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Daca întâmpinati orice problema utilizând Smarter Dog puteti cauta grupul oficial Google pentru raspunsuri. Deasemenea va trebui sa creati o noua întrebare acolo pe pagina Google Code pentru a ajuta la dezvoltarea aplicatiei.';
...
$lang['about_app_license'] = 'Smarter Dog este sub licenta GPLv3. folosind codul Smarter Dog în orice fel aduce cu sine acceptarea conditiilor descrise in urmatorul url:';
...
$lang['ea_update_success'] = 'Smarter Dog a fost actualizat.';
...
$lang['api_token_hint'] = 'Setați un token secret pentru a activa autentificarea bazată pe token a API-ului Smarter Dog.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vă permite să interacționați cu toate datele Smarter Dog prin protocolul HTTP și punctele de acces API disponibile și să creați propriile integrări.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Această integrare vă permite să vă conectați la un server LDAP existent și să importați automat utilizatorii în Smarter Dog, permițându-le să se autentifice cu parola din director (numele de utilizator trebuie să se potrivească).';
$lang['host'] = 'Gazdă';
$lang['port'] = 'Port';
