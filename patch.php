...
function detect_local_version()
{
    ...
    if (!file_exists($config_file_path)) {
        die(
            'Failed to detect the local Smarter Dog version, please move the patch.php script in the root directory of your Smarter Dog installation.'
        );
    }
...
echo LINE_BREAK . '➜ Smarter Dog - Patch Utility Script' . LINE_BREAK . LINE_BREAK;
