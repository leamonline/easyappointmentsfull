...
$lang['about_app_info'] = 'Smarter Dog er en svært tilpassbar webapplikasjon som lar kundene dine bestille avtaler med deg via nettet. Videre gir den muligheten til å synkronisere dataene dine med Google Kalender, slik at du kan bruke dem med andre tjenester.';
$lang['current_version'] = 'Nåværende Versjon';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Hvis du støter på problemer når du bruker Smarter Dog, kan du søke i det offisielle Google-gruppen etter svar. Du kan også trenge å opprette en ny sak på Google Code-siden for å hjelpe utviklingen fremover.';
...
$lang['license'] = 'Lisens';
$lang['about_app_license'] = 'Smarter Dog er lisensiert under GPLv3-lisensen. Ved å bruke koden til Smarter Dog på noen måte godtar du vilkårene beskrevet i følgende URL:';
...
$lang['ea_update_success'] = 'Smarter Dog har blitt oppdatert.';
...
$lang['api_token_hint'] = 'Angi et hemmelig token for å aktivere tokenbasert autentisering av Smarter Dog API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API gjør det mulig for deg å samhandle med alle Smarter Dog-data via HTTP-protokollen og de tilgjengelige API-endepunktene og opprette dine egne integrasjoner.';
