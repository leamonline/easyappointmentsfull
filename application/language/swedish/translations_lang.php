...
$lang['about_app_info'] = 'Smarter Dog är ett system som gör det möjligt för dina kunder att, via internet, boka tid för tjänster hos er. Bokningarna kan synkroniseras med dina leverantörers Google-kalendrar så att de bli tillgängliga även för andra tjänster.';
$lang['current_version'] = 'Nuvarande version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Om du stöter på problem när du använder Smarter Dog kan du söka i den officiella Google-gruppen för support. Du kan även underlätta för utvecklarna genom att registrera ett ärende på GitHub-sidan.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'Smarter Dog använder GPLv3 licensen. Genom att använda koden till Smarter Dog på något sätt accepterar du villkoren i följande url.';
...
$lang['ea_update_success'] = 'Smarter Dog är uppdaterad.';
...
$lang['api_token_hint'] = 'Ställ in en hemlig token för att aktivera tokenbaserad autentisering av Smarter Dog API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API gör att du kan interagera med all Smarter Dog-data via HTTP-protokollet och de tillgängliga API-slutpunkterna samt skapa egna integrationer.';
...
$lang['connect'] = 'Anslut';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Denna integration gör att du kan ansluta till en befintlig LDAP-server och automatiskt importera användare till Smarter Dog och låta dem använda SSO med sitt kataloglösenord (användarnamn måste matcha).';
$lang['host'] = 'Värd';
$lang['port'] = 'Port';
