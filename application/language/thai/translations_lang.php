...
$lang['about_app'] = 'เกี่ยวกับ Smarter Dog';
...
$lang['about_app_info'] = 'Smarter Dog เป็นเว็บแอปพลิเคชั่นที่ปรับแต่งได้สูง ซึ่งช่วยให้ลูกค้าของคุณสามารถจองการนัดหมายกับคุณผ่านทางเว็บได้ นอกจากนี้ยังให้ความสามารถในการซิงค์ข้อมูลของคุณกับ Google ปฏิทินเพื่อให้คุณสามารถใช้กับบริการอื่นๆ ได้';
$lang['current_version'] = 'เวอร์ชันปัจจุบัน';
$lang['support'] = 'สนับสนุน';
$lang['about_app_support'] = 'หากคุณพบปัญหาใดๆ เมื่อใช้ Smarter Dog คุณสามารถค้นหาคำตอบได้ใน Google Group อย่างเป็นทางการ คุณอาจต้องสร้างประเด็นใหม่ในหน้า Google Code เพื่อช่วยในการพัฒนาระบบต่อไป';
...
$lang['about_app_license'] = 'Smarter Dog ได้รับอนุญาตภายใต้ใบอนุญาต GPLv3 โดยใช้รหัส Smarter Dog ในทางใดทางหนึ่งถือว่าคุณยอมรับเงื่อนไขที่อธิบายไว้ใน URL ต่อไปนี้:';
...
$lang['ea_update_success'] = 'Smarter Dog อัปเดตเรียบร้อยแล้ว';
...
$lang['api_token_hint'] = 'ตั้งค่าโทเค็นลับเพื่อเปิดใช้งานการตรวจสอบสิทธิ์โดยใช้โทเค็นของ Smarter Dog API';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'การรวมนี้ช่วยให้คุณเชื่อมต่อกับเซิร์ฟเวอร์ LDAP ที่มีอยู่และนำเข้าผู้ใช้ไปยัง Smarter Dog อัตโนมัติ และให้พวกเขาเข้าสู่ระบบด้วยรหัสผ่านไดเร็กทอรีของพวกเขา (ชื่อผู้ใช้ต้องตรงกัน)';
$lang['host'] = 'โฮสต์';
$lang['port'] = 'พอร์ต';
