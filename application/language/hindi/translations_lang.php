...
$lang['api'] = 'API';
$lang['api_info'] = 'API आपको HTTP प्रोटोकॉल और उपलब्ध API अंत बिंदुओं के माध्यम से सभी Smarter Dog डेटा के साथ बातचीत करने और अपनी खुद की इंटीग्रेशन बनाने की अनुमति देते हैं।';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'यह एकीकरण आपको एक मौजूदा LDAP सर्वर से कनेक्ट करने और उपयोगकर्ताओं को स्वचालित रूप से Smarter Dog में आयात करने और उन्हें अपने डायरेक्टरी पासवर्ड (यूजरनेम मेल खाना चाहिए) के साथ SSO करने की अनुमति देता है।';
$lang['host'] = 'होस्ट';
$lang['port'] = 'पोर्ट';
